package com.zlx312.speech.controller;

import com.zlx312.speech.common.DemoException;
import com.zlx312.speech.common.ConnUtil;
import com.zlx312.speech.common.TokenHolder;
...
public class TtsMain {
    ...
    @GetMapping("speechsynthesis/text2audio")
    public static void main(String[] args) throws IOException, DemoException {
        (new TtsMain()).run();
    }

    //  填写网页上申请的appkey 如 $apiKey="g8eBUMSokVB1BHGmgxxxxxx"
    private final String appKey = "kPs31HHb4HySr9aojoDO7jDc";

    // 填写网页上申请的APP SECRET 如 $secretKey="94dc99566550d87f8fa8ece112xxxxx"
    private final String secretKey = "jh5xSaReEwsdHetCGfG5ZSSsZjRoGer6";
